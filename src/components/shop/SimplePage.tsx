...
export default function SimplePage({ title, subtitle, body }: { title: string; subtitle?: string; body?: string }) {
  return (
    <div className="relative bg-white w-full overflow-hidden" style={{ minHeight: "60vw" }}>
      ...
      <div className="flex flex-col items-center justify-center text-center px-[8vw] pt-[18vw] pb-[10vw] gap-[1.5vw]">
        ...
        <a href="/" className="mt-[1vw] bg-primary-brown text-white px-[3vw] py-[1vw] rounded-[0.8vw] ff-accia text-[1.3vw] hover:bg-primary-brown/90 transition-all">
          Back to Shop
        </a>
      </div>
